...
class TrackLikeButton extends StatefulWidget {
  final Track track;
  ...
  @override
  State<TrackLikeButton> createState() => _TrackLikeButtonState();
}

class _TrackLikeButtonState extends State<TrackLikeButton> {
  bool _isLiked = false;
