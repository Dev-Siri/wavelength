  ...
  fromJSON(object: any): GetSearchSuggestionsResponse {
    return {
      suggestedQueries: globalThis.Array.isArray(object?.suggestedQueries)
        ...
        : globalThis.Array.isArray(object?.suggested_queries)
        ? object.suggested_queries.map((e: any) => globalThis.String(e))
        : [],
      suggestedLinks: globalThis.Array.isArray(object?.suggestedLinks)
        ? object.suggestedLinks.map((e: any) => SuggestedLink.fromJSON(e))
        : globalThis.Array.isArray(object?.suggested_links)
        ? object.suggested_links.map((e: any) => SuggestedLink.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): GetQuickPicksResponse {
    return {
      quickPicks: globalThis.Array.isArray(object?.quickPicks)
        ...
        : globalThis.Array.isArray(object?.quick_picks)
        ? object.quick_picks.map((e: any) => QuickPick.fromJSON(e))
        : [],
    };
  },
...
export const GetUpNextRequest: MessageFns<GetUpNextRequest> = {
  encode(message: GetUpNextRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.automix !== false) {
      writer.uint32(8).bool(message.automix);
    }
    if (message.videoId !== "") {
  ...
  fromJSON(object: any): GetUpNextRequest {
    return {
      automix: isSet(object.automix) ? globalThis.Boolean(object.automix) : false,
  ...
  fromPartial<I extends Exact<DeepPartial<GetUpNextRequest>, I>>(object: I): GetUpNextRequest {
    const message = createBaseGetUpNextRequest();
    message.automix = object.automix ?? false;
...
function createBaseGetTrackInfoRequest(): GetTrackInfoRequest {
  return { videoId: "" };
}

export const GetTrackInfoRequest: MessageFns<GetTrackInfoRequest> = {
  encode(message: GetTrackInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.videoId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTrackInfoRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetTrackInfoRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetTrackInfoRequest {
    return {
      videoId: isSet(object.videoId)
        ? globalThis.String(object.videoId)
        : isSet(object.video_id)
  ...
  toJSON(message: GetTrackInfoRequest): unknown {
    const obj: any = {};
    if (message.videoId !== "") {
      obj.videoId = message.videoId;
    }
  ...
  create<I extends Exact<DeepPartial<GetTrackInfoRequest>, I>>(base?: I): GetTrackInfoRequest {
    return GetTrackInfoRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetTrackInfoRequest>, I>>(object: I): GetTrackInfoRequest {
    const message = createBaseGetTrackInfoRequest();
    message.videoId = object.videoId ?? "";
    return message;
  },
...
function createBaseGetTrackInfoResponse(): GetTrackInfoResponse {
  return { track: undefined };
}

export const GetTrackInfoResponse: MessageFns<GetTrackInfoResponse> = {
  encode(message: GetTrackInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTrackInfoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetTrackInfoResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetTrackInfoResponse {
    return { track: isSet(object.track) ? Track.fromJSON(object.track) : undefined };
  },

  toJSON(message: GetTrackInfoResponse): unknown {
    const obj: any = {};
    if (message.track !== undefined) {
  ...
  create<I extends Exact<DeepPartial<GetTrackInfoResponse>, I>>(base?: I): GetTrackInfoResponse {
    return GetTrackInfoResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetTrackInfoResponse>, I>>(object: I): GetTrackInfoResponse {
    const message = createBaseGetTrackInfoResponse();
...
export const YTScraperService = {
  getSearchSuggestions: {
    path: "/yt_scraper.YTScraper/GetSearchSuggestions" as const,
  ...
  getQuickPicks: {
    path: "/yt_scraper.YTScraper/GetQuickPicks" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  getAlbumDetails: {
    path: "/yt_scraper.YTScraper/GetAlbumDetails" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  getArtistDetails: {
    path: "/yt_scraper.YTScraper/GetArtistDetails" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  getUpNext: {
    path: "/yt_scraper.YTScraper/GetUpNext" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  searchTracks: {
    path: "/yt_scraper.YTScraper/SearchTracks" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  searchArtists: {
    path: "/yt_scraper.YTScraper/SearchArtists" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  searchAlbums: {
    path: "/yt_scraper.YTScraper/SearchAlbums" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  searchYouTubeVideos: {
    path: "/yt_scraper.YTScraper/SearchYouTubeVideos" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  getTrackInfo: {
    path: "/yt_scraper.YTScraper/GetTrackInfo" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: GetTrackInfoRequest): Buffer => Buffer.from(GetTrackInfoRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetTrackInfoRequest => GetTrackInfoRequest.decode(value),
    responseSerialize: (value: GetTrackInfoResponse): Buffer =>
      Buffer.from(GetTrackInfoResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetTrackInfoResponse => GetTrackInfoResponse.decode(value),
  },
} as const;
...
export interface YTScraperServer extends UntypedServiceImplementation {
  ...
  getTrackInfo: handleUnaryCall<GetTrackInfoRequest, GetTrackInfoResponse>;
}
...
export interface YTScraperClient extends Client {
  ...
  getTrackInfo(
    request: GetTrackInfoRequest,
    callback: (error: ServiceError | null, response: GetTrackInfoResponse) => void,
  ): ClientUnaryCall;
  getTrackInfo(
    request: GetTrackInfoRequest,
    metadata: Metadata,
